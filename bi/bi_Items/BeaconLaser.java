...
public class BeaconLaser extends Item
{
	public BeaconLaser(int par1) 
	{
		...
		this.setUnlocalizedName(Strings.BEACON_LASER);
	}
	@Override
	@SideOnly(Side.CLIENT)
	public void registerIcons(IconRegister par1IconRegister)
    {
        this.itemIcon = par1IconRegister.registerIcon(Strings.BEACON_LASER);
    }
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Item.arrow.itemID))
        {
            ...
            EntityLaserMunition entityarrow = new EntityLaserMunition(par2World, par3EntityPlayer, f * 2.0F);
