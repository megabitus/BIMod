...
public class TileEntityGlowNuggetChestRender extends TileEntitySpecialRenderer
{
	private static final ResourceLocation field_110635_a = new ResourceLocation("textures/gui/chests/Glowchest.png");
    private static final ResourceLocation field_110634_c = new ResourceLocation("textures/gui/chests/largeGlowchest.png");
	...
	public TileEntityGlowNuggetChestRender()
	{
	 ...
	 */
	public void renderTileEntityChestAt(TileEntityGlowNuggetChest par1TileEntityChest, double par2, double par4, double par6, float par8)
	{
		int i;
		...
		else
		{
			...
			if (block instanceof GlowNuggetChest && i == 0)
			{
				try
				{
					((GlowNuggetChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
				}
	...
	{
		this.renderTileEntityChestAt((TileEntityGlowNuggetChest)par1TileEntity, par2, par4, par6, par8);
	}
}
