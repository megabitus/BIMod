...
public class BlockMultiFurnaceCore extends BlockContainer
{
	...
	public void registerIcons(IconRegister iconRegister)
	{
		...
		faceIconUnlit = iconRegister.registerIcon("multifurnace:MultiFurnace_Front_Unlit");
		faceIconLit = iconRegister.registerIcon("multifurnace:MultiFurnace_Front_Lit");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
	{
		...
		if(tileEntity != null)
		{
			...
			if(tileEntity.getIsValid())
				player.openGui(BaseClass.instance, 10, world, x, y, z);
		}
