...
public class GlowNuggetChest extends BlockContainer
{
	...
	protected GlowNuggetChest(int par1, int par2)
	{
		...
		this.setUnlocalizedName(Strings.GLOW_NUGGET_CHEST);
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
	{
		...
		{
			((TileEntityGlowNuggetChest)par1World.getBlockTileEntity(par2, par3, par4)).func_94043_a(par6ItemStack.getDisplayName());
		}
	}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
	{
		...
		TileEntityGlowNuggetChest TileEntityGlowNuggetChest = (TileEntityGlowNuggetChest)par1World.getBlockTileEntity(par2, par3, par4);

		if (TileEntityGlowNuggetChest != null)
		{
			TileEntityGlowNuggetChest.updateContainingBlockInfo();
		}
	}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
	{
		...
		if (TileEntityGlowNuggetChest != null)
		{
			for (int j1 = 0; j1 < TileEntityGlowNuggetChest.getSizeInventory(); ++j1)
			{
				ItemStack itemstack = TileEntityGlowNuggetChest.getStackInSlot(j1);
	...
	{
		Object object = (TileEntityGlowNuggetChest)par1World.getBlockTileEntity(par2, par3, par4);
		...
		else
		{
			if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
			{
				object = new InventoryLargeChest("GlowNugget Chest", (TileEntityGlowNuggetChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
			}

			if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
			{
				object = new InventoryLargeChest("GlowNugget Chest", (IInventory)object, (TileEntityGlowNuggetChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
			}

			if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
			{
				object = new InventoryLargeChest("GlowNugget Chest", (TileEntityGlowNuggetChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
			}

			if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
			{
				object = new InventoryLargeChest("GlowNugget Chest", (IInventory)object, (TileEntityGlowNuggetChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
			}
	...
	{
		TileEntityGlowNuggetChest TileEntityGlowNuggetChest = new TileEntityGlowNuggetChest();
		return TileEntityGlowNuggetChest;
	}
	/**
	...
	public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
	{
		...
		{
			int i1 = ((TileEntityGlowNuggetChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("tile.GlowingPlank");
	}
}